...
const COLUMNS = [
    ...
    { type: 'numeric', title: 'Total', width: 120, mask: '$ #,##0.00', name: 'total_price', readOnly: true }, // Logic handled by calculation or backend? Formula support in jspreadsheet exists but needs setup.
];
...
export default function ContractDetailPage() {
  ...
  // Define the handle type for better TS support (optional, but good practice)
  // interface SheetHandle { getJson: () => any[]; ... }
